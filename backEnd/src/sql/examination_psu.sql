...
--
-- Host: localhost:3306
-- Generation Time: Jul 05, 2021 at 01:56 AM
...
INSERT INTO `administrator` (`citizen_id`, `username`, `password`, `surName`, `lastName`, `phoneNumber`, `token`, `updatedAt`, `createdAt`) VALUES
('1959900608046', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'admin', '0810990397', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjaXRpemVuX2lkIjoiMTk1OTkwMDYwODA0NiIsInVzZXJuYW1lIjoiYWRtaW4iLCJwaG9uZU51bWJlciI6IjA4MTA5OTAzOTciLCJpYXQiOjE2MjU0MzQyMzcsImV4cCI6MTYyNTQ3MDIzN30.tc1bgdpqieltU0tFT_UGsSsaDTxMev9pzgV008Mhmsc', '2021-07-05 04:30:37', '2021-07-03 17:48:02');
...
CREATE TABLE `users` (
  ...
  `img_cardId` varchar(255) NOT NULL,
  `surName` varchar(100) NOT NULL,
  `lastName` varchar(100) NOT NULL,
  `phoneNumber` varchar(10) NOT NULL,
  `vehicle` varchar(255) NOT NULL,
  `travelType` varchar(100) DEFAULT NULL,
  `province` int(100) DEFAULT NULL,
  `district` int(100) DEFAULT NULL,
  `amphures` int(100) DEFAULT NULL,
  `foreign_address_id` int(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `users`
  ...
  ADD KEY `foreign_address_id` (`foreign_address_id`),
  ADD KEY `province` (`province`,`district`,`amphures`);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`foreign_address_id`) REFERENCES `foreign_address` (`address_id`);
COMMIT;
